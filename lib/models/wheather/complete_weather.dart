...
class CompleteWeatherService {
  ...
  // static Future<CompleteWeatherService> reloadWeather(int cityId) async {
  //   Forecast forecast = await fetchWeatherForecast(cityId);
  //   CurrentAndDailyWeather weather = await fetchCurrentAndDailyWeather(
  //       forecast.city.coord.lat, forecast.city.coord.lon);
...
//   Future<CompleteWeatherService> future;
//   int cityId;
//   CompleteWeatherFuture() {
//     this.cityId = 0;
//     future = CompleteWeatherService.reloadWeather(//Thist is the first load to
//         0); //ToDo change to current positions cityId
//   }

//   void reload(int cityId) {
//     this.cityId = cityId;
//     future = CompleteWeatherService.reloadWeather(cityId);
//     notifyListeners();
//   }
